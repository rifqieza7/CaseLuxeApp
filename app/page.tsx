  ...
  <div className="container mx-auto px-6 py-3 md:flex md:justify-between md:items-center">
    ...
    <div className="md:flex items-center first-letter:">
      <div className="flex flex-col md:flex-row md:mx-6 sty">
        <a className="my-1 text-lg text-gray-700 font-medium hover:text-indigo-500 md:mx-4 md:my-0" href="#">Home</a>
        <a className="my-1 text-lg text-gray-700 font-medium hover:text-indigo-500 md:mx-4 md:my-0" href="#">Shop</a>
        <a className="my-1 text-lg text-gray-700 font-medium hover:text-indigo-500 md:mx-4 md:my-0" href="#">Contact</a>
        <a className="my-1 text-lg text-gray-700 font-medium hover:text-indigo-500 md:mx-4 md:my-0" href="#">About</a>
      </div>
