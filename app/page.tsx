...
import { phoneData } from "@/data/iphone";
		...
		<main>
			...
			<section className="bg-repeat bg-cover bg-[url('/image/jumbotron.png')]">
				<div className='px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56'>
					<h1 className='mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-700 lg:text-6xl'>
						<span className='bg-white'>CASELUXE</span>
					</h1>
					<p className='mb-8 text-lg font-bold text-gray-700 lg:text-3xl sm:px-16 lg:px-48'>
						<span className='bg-white'>
							Protect Your Style, Showcase Your Device: Find Your Perfect Phone
							Case Here!
						</span>
					</p>
				</div>
			...
			<div className='grid grid-cols-12 gap-10 mt-7 mb-10 p-10'>
				{phoneData?.map((item) => {
					return (
						<div
							key={item?.id}
							className='lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-full'
						>
							<CardPhone
								isHot={item?.isHot}
								image={item?.image}
